          ...
          <button type="c-button" class="c-button is-borderless">
            ...
            <span class="current-app__switch-apps-label">
              切换空间
                    ...
                    <!--&lt;!&ndash;<img class="c-app-icon__img image" :src="curApp.logo_url" v-if="curApp.logo_url">&ndash;&gt;-->
                        ...
                        <ul>
                            <nuxt-link :to="menuItem.link"
                                ...
                                <nuxt-link :to="menuItem.action"
                                           class="c-sidebar__button" v-if="menuItem.action">添加
                                </nuxt-link>
            ...
            <div class="c-sidebar__footer">
                <button class="c-button inline-help is-borderless" title="帮助" type="button">
                    <svg class="gridicon gridicons-help-outline" height="24" width="24"
                         xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 24 24">
                        <g>
                            <path
